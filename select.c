Next: Out-of-Band Data, Previous: Byte Stream Example, Up: Connections   [Contents][Index]
...
main (void)
{
  ...
  FD_SET (sock, &active_fd_set);  //sock is in active
